...
\begin{itemize}
    \item \link{https://applied.cs.colorado.edu/mod/quiz/view.php?id=55926}{Math And Pandas Quiz} \textbullet \pdflink{\QuizDir }{Finalized Math And Pandas Quiz} \assignment{2/6/24}{Quiz3DueDate}
\end{itemize}